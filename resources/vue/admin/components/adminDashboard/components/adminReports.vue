                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-center">Reasons</th>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <span>1, Juanuary, 1997</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                       <span class="bg-purple-200 text-purple-600 py-1 pr-2 pl-2  mr-1 rounded-full text-xs"> <span class="border-2 border-stone-100 rounded-full mr-1">12</span>Active</span>
                                       <span class="bg-red-200 text-red-600 py-1 pr-2 pl-2  mr-1 rounded-full text-xs"> <span class="border-2 border-stone-100 rounded-full mr-1">12</span>Active</span>
                                       <span class="bg-yellow-200 text-yellow-600 py-1 pr-2 pl-2  mr-1 rounded-full text-xs"> <span class="border-2 border-stone-100 rounded-full mr-1">12</span>Active</span>
