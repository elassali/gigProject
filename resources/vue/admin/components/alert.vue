<template>
    ...
    <div v-if="alert" class="bg-blue-100 rounded-lg py-5 px-6 mb-3 text-base text-blue-700 inline-flex items-center absolute right-0 top-0 mt-2 mr-2" role="alert">
